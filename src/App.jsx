  ...
  return (
    <div style={{ position: 'relative', width: '100%', height: '100%' }}>
      ...
      <div style={{
        ...
        <div style={{ position: 'absolute', top: '0.75rem', left: 'clamp(380px, 35vw, 500px)', right: 'clamp(380px, 35vw, 500px)', display: 'flex', justifyContent: 'center', pointerEvents: 'none', zIndex: 10 }}>
